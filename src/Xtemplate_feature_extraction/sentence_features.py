...
from src.Xtemplate_feature_extraction.utils import load_pos_tagger

# What modules are available
from src.Xtemplate_feature_extraction.read_config import enabled_modules
...
# if enabled['UMLS']:
from src.Xtemplate_feature_extraction.umls_dir import interface_umls
from src.Xtemplate_feature_extraction.umls_dir import interpret_umls

from src.Xtemplate_feature_extraction.umls_dir import umls_features as feat_umls

from src.Xtemplate_feature_extraction.umls_dir.umls_cache import UmlsCache

umls_cache = UmlsCache()

from src.Xtemplate_feature_extraction import word_features as feat_word
...
def IOB_nonprose_features(sentence):
    ...
    if 'UMLS' in enabled_IOB_nonprose_sentence_features:
