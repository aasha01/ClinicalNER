...
enabled_IOB_prose_word_features = frozenset(
    [feature_generic, feature_last_two_letters, feature_word, feature_length, feature_stem_porter, feature_mitre,
...
enabled_word_concept_features = frozenset(
    [feature_word, feature_prefix, feature_stem_porter, feature_stem_lancaster, feature_word_shape, feature_metric_unit,
     feature_mitre])
